...
import islandScene from '../assets/preview/fantasy_island.glb'
...
const islandRef = useRef();
  ...
  {/** Deberia ser agua
      <mesh
        ...
        position={[0, -3.036, 0]}
      />
      <mesh geometry={nodes.Object_238.geometry} position={[0, -3.036, 0]}>
  
  <meshPhysicalMaterial
    color="#4f84c4"
    transmission={0.9} // Simula refracción
    thickness={0.5} // Profundidad del agua
    roughness={0.1}
    metalness={0.2}
    clearcoat={1} // Capa de brillo
  />
</mesh>
**/ }
