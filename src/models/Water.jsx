...
const WaterShaderMaterial = shaderMaterial(
  {
    ...
    uBigWavesFrequency: new THREE.Vector2(3.218, 2.058),
    uBigWavesSpeed: 0.854,
    uDepthColor: new THREE.Color("#1bc4ee"),
    uSurfaceColor: new THREE.Color("#ffffff"),
    uColorOffset: 0.08,
    uColorMultiplier: 5,
    uSmallWavesElevation: 0.198,
    uSmallWavesFrequency: 1.301,
    uSmallWavesSpeed: 0.274,
    uSmallIterations: 3,
  },
  // Vertex Shader
  `
