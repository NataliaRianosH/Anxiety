...
const Game = () => {
  const achievementsData = [
    { id: 1, position: [5, 0, 2], shape: "box" },
    { id: 2, position: [-3, 0, 4], shape: "sphere" },
    { id: 3, position: [2, 0, -5], shape: "box" },
    { id: 4, position: [-6, 1, -3], shape: "sphere" },
    { id: 5, position: [-30, 0, -13], shape: "box" },
